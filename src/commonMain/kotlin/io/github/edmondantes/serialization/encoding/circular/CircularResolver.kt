...
public interface CircularResolver {
     ...
     * @return True if [obj] was added, false if [obj] already was in [CircularResolver]
     */
    public fun add(obj: Any): Boolean

    /**
     * Check for [obj] presence
     * @return True if [obj] already was in [CircularResolver], else false
     */
